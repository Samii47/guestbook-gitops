...
│   ├── 🌐 Domain: guestbook-samich.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-samich.duckdns.org/
...
- DNS record pointing `guestbook-samich.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/samii47/guestbook-gitops
   ```
